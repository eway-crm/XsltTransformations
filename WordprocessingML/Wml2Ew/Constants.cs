namespace Wml2Ew
{
    class Constants
    {
        internal const string WML2XSLT_FILE_NAME = "WML2XSLT.EXE";

        internal const string XML_NAMESPACE_PARAMETER = "$XmlNamespace$";
        internal const string FILEAS_PARAMETER = "$FileAs$";
        internal const string FOLDER_NAME_PARAMETER = "$FolderName$";
        internal const string LANGUAGE_CODE_PARAMETER = "$LanguageCode$";
